...
public class MultidimensionalArrayByValueListExample {
	public static void main(String[] args) {
		...
		// 각 반의 평균 점수 구하기
		for (int[] arr : scores) { // 2차원을 1차원씩
			int classSum = 0;
			for (int score : arr) { // 1차원을 상수로
				classSum += score;
			}
			double classAvg = (double) classSum / arr.length; // 반별 평균
			System.out.println("반의 평균 점수: " + classAvg);
		}
